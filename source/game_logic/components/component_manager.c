...
bool initialize_all_components() {
  ...
  return initialize_position_component() && initialize_velocity_component() &&
         ...
         initialize_ai_component() && initialize_rotation_component()&&initialize_scale_component();
}
...
void static __attribute__((constructor(203))) init() { initialize_all_components(); }